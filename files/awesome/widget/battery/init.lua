...
ICONS = "/usr/share/icons/Papirus-Dark/symbolic/status/"
...
local function worker(user_args)
    ...
    local path_to_icons = args.path_to_icons or ICONS
    ...
    local warning_msg_icon = args.warning_msg_icon or ICONS .. 'battery-caution-symbolic.svg'
