...
apply() {
  ...
  _write audible-bell "false"
  _write default-size-columns "80"
  _write login-shell "true"
  _write use-theme-colors "false"
  _write use-theme-background "false"
  _write use-theme-transparency "false"
  _write background-transparency-percent "20"
  ...
  dconf write  "$DCONF_PROFILE_BASE_PATH/default" "'$profile_uuid'"
  log 4 "Applied Nord as default profile"
